...
export default class Exhaust extends ExtendedObject3D {
  material1: THREE.ShaderMaterial | undefined
  material2: THREE.ShaderMaterial | undefined
  material3: THREE.ShaderMaterial | undefined

  constructor() {
    super()
  }

  mesh(scene: THREE.Scene) {
  ...
  updateDraw(delta: number) {
    if (this.material1! && this.material2! && this.material3!) {
      console.log('update')
      this.material1.uniforms.time.value = -delta / (1000 * 2);
      this.material2.uniforms.time.value = -delta / (3000 * 2);
      this.material3.uniforms.time.value = -delta / (3000 * 2);
      // this.material1.uniforms.color5.value = new THREE.Vector3(...options.color5);
      // this.material2.uniforms.color4.value = new THREE.Vector3(...options.color4);
      // this.material3.uniforms.color4.value = new THREE.Vector3(...options.color5);
      // this.material1.uniforms.color3.value = new THREE.Vector3(...options.color3);
      // this.material1.uniforms.color2.value = new THREE.Vector3(...options.color2);
      // this.material1.uniforms.color1.value = new THREE.Vector3(...options.color1);
      // this.material1.uniforms.color0.value = new THREE.Vector3(...options.color0);
    }
